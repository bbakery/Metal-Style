    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <section className="max-w-4xl mx-auto">
        <article className="bg-zinc-800 p-6 rounded-lg mb-8">
          ...
          <p className="text-zinc-300 mb-4">
            Художник є магістром Львівської національної академії мистецтв. До вступу в Академію він навчався у Косівському інституті
            прикладного та декоративного мистецтва на відділі художнього металу: 4 роки в училищі та 4 роки в інституті. Після цього
            вступив до Львівської національної академії мистецтв також на відділ художнього металу.
          </p>
          <p className="text-zinc-300 mb-4">
          ...
          <p className="text-zinc-300">
            ...
            Ми також підтримуємо високу професійну декоративно-прикладну майстерність у кожному виробі.
          </p>
        </article>
